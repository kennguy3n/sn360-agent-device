...
//!
//! Wraps `wda_pal::fs_watcher::FsWatcher` and adds debounce logic:
...
use wda_pal::fs_watcher::FsWatcher;
use wda_pal::types::{FsEvent, FsEventKind};
...
impl DebouncedWatcher {
    ...
    pub fn new(debounce_ms: u64) -> Result<Self, wda_pal::fs_watcher::FsWatcherError> {
    ...
    pub fn watch(
        ...
        path: &std::path::Path,
        recursive: bool,
    ) -> Result<(), wda_pal::fs_watcher::FsWatcherError> {
