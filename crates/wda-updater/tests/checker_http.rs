//! Integration tests for [`wda_updater::checker`] using a hand-rolled
...
use wda_updater::check_for_update;
...
async fn newer_version_is_returned() {
    let body = r#"{
        "version": "9.9.9",
        "url": "https://cdn.example.invalid/wda-agent-9.9.9",
        "sha256": "deadbeef",
        "signature": "abcd"
    }"#
    .to_string();
...
async fn older_or_equal_version_returns_none() {
    let body = r#"{
        "version": "0.0.1",
        "url": "https://cdn.example.invalid/wda-agent-0.0.1",
        "sha256": "deadbeef",
        "signature": "abcd"
    }"#
    .to_string();
